<?php echo "\t".'<!-- START - Ručne pridané správy -->'; $cisloRucnejSpravy=0?>	
<?php
	$titulok = 'VYVOJ - Detský letný kresťanský tábor';
	$farba   = 'Červená';
	$napisal = 'Janko Fízik';
	$datum   = '12.10.2017';
	
	$cisloRucnejSpravy++; echo hlavickaSpravy ($titulok, $farba, $odsadenie = $odsadenieTextu, $cisloSpravy = $cisloRucnejSpravy); ?>
...
<?php echo petickaSpravy ($napisal, $datum, $odsadenie = $odsadenieTextu, $cisloSpravy = 1); echo PHP_EOL;?>
<?php
	$titulok = 'VYVOJ - Pozvánka na spoločnú modlitbu';
	$farba   = 'Červená';
	$napisal = 'Ondrej Vrťo';
	$datum   = '12.05.2017';
...
<?php echo petickaSpravy ($napisal, $datum, $odsadenie = $odsadenieTextu, $cisloSpravy = 2); echo PHP_EOL;?>
<?php echo "\t".'<!-- END - Ručne pridané správy -->' .PHP_EOL .PHP_EOL;?>