<?php 
	...
	$nadpisStrankyPreTlac = 'Čistá stránka';
	
	$navsivitPo = '30 days';
	$nastavenieRobots = 'noindex, nofollow';
	
	$popisStranky = 'Farnosť Detva - čistá stránka, na ktorej nieje žiadny obsah. Zobrazuje sa pri neexistujúcom odkaze.';
	$klucoveslova = 'Detva, fara, kostol, farnosť, error, 404, pracuje';
