 ...
 */
	...
	class QRsvgOutput extends QRarea {
        ...
        public function getRawSvg()
		{
				...
				switch ($path[0]) {
					...
					case QR_AREA_TRACKER:
							...
							if (!isset($lib['tracker'])) {
								$lib['tracker'] = '<symbol id="tracker"><path d="m 0 7 0 7 7 0 0 -7 -7 0 z m 1 1 5 0 0 5 -5 0 0 -5 z m 1 1 0 3 3 0 0 -3 -3 0 z" style="fill:#d9d9d9;stroke:none"></path></symbol>';
							}
			...
			$svg[] = '<path d="'.join(' ', $aggregate_paths).'" style="fill:#d9d9d9;stroke:none" ></path>';
