...
(
	1 => array(
		"Special"	 		=>  true,
		"TextSpecial"	 	=>  '			<article class="card border border-danger my-3" role="region">
				<div class="card-header bg-danger">
					<h1 class="card-title">SPECIAL - Detský letný kresťanský tábor</h1>
				</div>
		...
		"DatumZobrazenia"	=> '17.08.2016',
		"DatumStiahnutia"	=> '17.08.2020',

		"Farba" 				=> 'Zelená',
		"Peticka"	 		=>  False,
		"BielyText" 		=>  False,
		
		"DatumVlozenia"	=> '17.08.2016',
		"Titulok" 			=> 'Detský letný kresťanský tábor',
		"TextSpravy" 		=> '					<img class="mx-auto ml-lg-3 mb-3 d-block img-thumbnail float-lg-right" width="350" src="/_aktuality/2016-2Q/Detsky-tabor-2015-a025.jpg" alt="Tábor na farskom dvore" />
					<p class="text-justify"><strong>Farnosť Detva</strong> organizuje <strong>detský letný kresťanský tábor</strong>, určený pre deti 1. – 9.
					ročníka ZŠ, ktorý sa uskutoční <strong>22. 8. – 27. 8. 2016</strong> v Kokave nad Rimavicou na chate Hámor. Cena tábora je 85,-€ a maximálny počet detí je 50. Prihlasiť svoje
					dieťa môžete každú nedeľu po detskej sv. omši v sakrestií. Pri prihlasovaní uprednostňujeme deti z našej farnosti s trvalým pobytom v Detve.</p>
					<p class="text-justify">Ak máte záujem o prihlásenie do tábora, tak po sv. omši si môžete vziať prihlášku, ktorú nájdete na
					...
					<p class="text-justify">Ak chcete podporiť kresťanský tábor, tak to môžete urobiť aj
					darovaním 2% vašej dane. Tlačivá sa nachádzajú v kostole na stolíku s časopismi.</p>',
		"TextPeticka" 		=>  '					<span class="card-text float-left"><small>Napísal:</small> Janko Fízik</span>
					<span class="card-text float-right">12.10.2017</span>',
		),
	...
	2 => array(
		...
		"DatumVlozenia"	=> '17.08.2016',
		"Titulok" 			=> 'Detský letný kresťanský tábor',
		"TextSpravy" 		=> '					<img class="ml-3 mb-3 img-thumbnail float-right" width="350" src="/_aktuality/2016-2Q/Detsky-tabor-2015-a025.jpg" alt="Tábor na farskom dvore" />
					<p class="text-justify"><strong>Farnosť Detva</strong> organizuje <strong>detský letný kresťanský tábor</strong>, určený pre deti 1. – 9.
					ročníka ZŠ, ktorý sa uskutoční <strong>22. 8. – 27. 8. 2016</strong> v Kokave nad Rimavicou na chate Hámor. Cena tábora je 85,-€ a maximálny počet detí je 50. Prihlasiť svoje
					dieťa môžete každú nedeľu po detskej sv. omši v sakrestií. Pri prihlasovaní uprednostňujeme deti z našej farnosti s trvalým pobytom v Detve.</p>
					<p class="text-justify">Ak máte záujem o prihlásenie do tábora, tak po sv. omši si môžete vziať prihlášku, ktorú nájdete na
	...
	3 => array(
		...
		"DatumVlozenia"	=> '12.05.2017',
		"Titulok" 			=> 'Pozvánka na spoločnú modlitbu',
		"TextSpravy" 		=> '					<img class="mx-auto ml-lg-3 mb-3 d-block img-thumbnail float-lg-right" width="200" src="/_aktuality/2016-2Q/plagat-ruzenec-k-boziemu-milosrdenstvu.jpg" alt="Plagát a pozvánka na ruženec k božiemu milosrdenstvu" />
		...
		"TextPeticka" 		=>  '					<span class="card-text float-left"><small>Napísal:</small> Ondrej Vrťo</span>
